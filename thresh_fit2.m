...
window = 15; % windown for removing too-close peaks. value 5 is based on bin width of peaks (5 for single ab, 
...
sumi1(1,i)=data(index1(i))+data(index1(i)-1)+data(index1(i)+1)-baseline*3;
end

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
interval = mad1; %default value is mad1
